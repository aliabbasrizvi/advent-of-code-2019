...
manhattan1 = [[0 for m in range(grid_size)] for n in range(grid_size)]
manhattan2 = [[0 for m in range(grid_size)] for n in range(grid_size)]
...
min_distance = grid_size * 200
all_intersections = []
for i in range(grid_size):
  for j in range(grid_size):
    if manhattan1[i][j] == 1 and manhattan1[i][j] == manhattan2[i][j]:
      all_intersections.append((i, j))
